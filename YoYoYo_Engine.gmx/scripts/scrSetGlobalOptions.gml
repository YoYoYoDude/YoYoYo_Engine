...
global.debugMode = false;       //enables debug keys (check objWorld step to see all of them), make sure to set this to 0 before releasing your game
...
global.timeWhenDead = true;        //sets whether or not to count the timer when the player is dead
global.edgeDeath = true;           //sets whether to kill the player when he leaves the room
...
global.delayBow = false;            //sets whether to delay the player bow's movement by a frame or not (most engines have the bow lagging behind the player by a frame)
