...
global.roomCaptionDef = "I Wanna Be The Studio Engine YoYoYo Edition v1.52";  //sets default window caption (only works with the Professional version of Studio)
